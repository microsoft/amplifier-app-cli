...
class KeyManager:
    ...
    def save_key(self, key_name: str, key_value: str) -> None:
        ...
        with self._lock:
            ...
            # Write back atomically: tmp-file-in-same-dir, fsync, os.replace,
            # so a reader (or a crash) never observes a partially-written
            # keys.env. See utils/atomic_write.py.
            lines = [
                "# Amplifier API Keys\n",
            ...
            atomic_write_text(self.keys_file, "".join(lines))
